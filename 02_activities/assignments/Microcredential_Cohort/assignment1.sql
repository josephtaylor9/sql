...
--QUERY 8
SELECT vendor_name, COUNT(vendor_booth_assignments.vendor_id) as booth_rental_count
FROM vendor
INNER JOIN vendor_booth_assignments
	ON vendor.vendor_id = vendor_booth_assignments.vendor_id
...
--QUERY 9
SELECT c.customer_id,customer_first_name, customer_last_name, SUM(cost_to_customer_per_qty) as 'total_purchases'
FROM customer as c
INNER JOIN customer_purchases as cp
	ON c.customer_id = cp.customer_id
GROUP BY c.customer_id
HAVING total_purchases > 2000.00
...
-- Though we could create the temp table with vendor_ID INTEGER PRIMARY KEY AUTOINCREMENT instead of using SELECT *
